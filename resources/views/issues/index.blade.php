    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <nav class="navbar navbar-light bg-light pb-5 pt-3">
                    <h2>Questions</h2>
                    <form class="form-inline">
                        <input class="form-control mr-sm-2" value="{{ $search ?? '' }}" type="search" placeholder="Search"
                ...
                {!! $issues->appends(['search' => $search ?? ''])->render() !!}
