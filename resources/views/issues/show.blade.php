    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <div class="row pb-5">
                    asked by {{ $issue->user->name }} - {{ \Carbon\Carbon::parse( $issue->created_at)->diffForHumans() }}
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 60px;text-align:center">
                                <vote-buttons type="issues" issue-id="{{ $issue->id }}" votes="{{ $votes }}" my-vote="{{ $myVote }}">
                                </vote-buttons>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="d-flex pb-3">
                                    @foreach ($issue->tags as $tag)
                                        <button type="button" class="btn btn-primary btn-sm" style="margin-right:7px; margin-top:7px;">
                                            {{ strtoupper($tag->name) }}
                                        </button>
                                    @endforeach
                                </div>
                            ...
                            @foreach ($issue->solutions()->get() as $solution)
                                <tr>
                                    <td style="width: 60px;text-align:center">
                                        ...
                                        <vote-buttons type="solutions"
                                        issue-id="{{ $solution->id }}"
                                ...
                                <td>
                                        ...
                                        @foreach ($solution->attachments()->get() as $attachment)
                                            ...
                                            <div class="card" style="width: 18rem;">
                                              ...
                                              <div class="card-body">
                                                ...
                                                <a href="/download/{{ $attachment->file_name }}" class="card-link">Download</a>
                                              </div>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="pb-5 pt-1" style="color: #999999">
                                            Answered {{ \Carbon\Carbon::parse( $solution->created_at)->diffForHumans() }} - {{ $solution->user->name }}
                                        </div>
                                        @can('update', $solution)
